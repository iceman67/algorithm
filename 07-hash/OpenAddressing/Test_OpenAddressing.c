...
/*
ProjectProperties -> Configuration Properties -> C/C++ -> Preprocessor -> Preprocessor Definitions, add following macros:
...
/*
printf("Key:%s, Value:%s\n", "HPQ", OAHT_Get(HT, "HPQ")); 추가시 Collision 발생
*/
int main( void )
{
	...
	OAHT_Set(&HT, "HPQ", "Hewlett-Packard Inc.");
	OAHT_Set(&HT, "yhkang", "강윤희/8578-0043");
